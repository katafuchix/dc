...
class Dc_AnimeGeneratorManager extends Ethna_AppManager
{
...
print $cmd;
		*/
		$cmd = "/usr/bin/perl /var/www/html/dc/bin/anime.pl {$this->flg} {$this->moji} {$this->font} {$this->x} {$this->y} {$this->color} {$this->size}";
//print $cmd;
/*
