...
namespace Magick
{
  ...
  //
  //struct MagickDLLDecl std::unary_function<MagickLib::DrawingWand *,void>;
  class MagickDLLDecl DrawableBase:
    public std::unary_function<MagickLib::DrawingWand *,void>
  {
  public:
    // Constructor
    DrawableBase ( void )
    ...
    virtual void operator()( MagickLib::DrawingWand * ) const = 0;
...
#undef Drawable  // Conflict with <X11/Xproto.h>
  ...
  public:
    ...
    void operator()( MagickLib::DrawingWand * context_ ) const;
...
public:
  ...
  // Operator to invoke equivalent draw API call
  virtual void operator()( MagickLib::DrawingWand * context_ ) const = 0;
...
public:
  ...
  // Operator to invoke equivalent draw API call
  /*virtual*/ void operator()( MagickLib::DrawingWand * context_ ) const;
