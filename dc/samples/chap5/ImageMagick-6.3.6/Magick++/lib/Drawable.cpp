...
void Magick::Drawable::operator()( MagickLib::DrawingWand * context_ ) const
{
  if(dp)
...
// Operator to invoke contained object
void Magick::VPath::operator()( MagickLib::DrawingWand * context_ ) const
{
  if(dp)
    dp->operator()( context_ );
}
...
void Magick::DrawableAffine::operator()( MagickLib::DrawingWand * context_ ) const
{
...
void Magick::DrawableArc::operator()( MagickLib::DrawingWand * context_ ) const
{
...
void Magick::DrawableBezier::operator()( MagickLib::DrawingWand * context_ ) const
{
...
void Magick::DrawablePopClipPath::operator() ( MagickLib::DrawingWand * context_ ) const
{
...
void Magick::DrawablePushClipPath::operator()
  ( MagickLib::DrawingWand * context_ ) const
{
...
void Magick::DrawableClipPath::operator()( MagickLib::DrawingWand * context_ ) const
{
...
void Magick::DrawableCircle::operator()( MagickLib::DrawingWand * context_ ) const
{
...
void Magick::DrawableColor::operator()( MagickLib::DrawingWand * context_ ) const
{
...
void Magick::DrawableFont::operator()( MagickLib::DrawingWand * context_ ) const
{
  // font
  if(_font.length())
    {
...
void Magick::DrawableLine::operator()( MagickLib::DrawingWand * context_ ) const
{
...
void Magick::DrawableMatte::operator()( MagickLib::DrawingWand * context_ ) const
{
...
void Magick::DrawablePath::operator()( MagickLib::DrawingWand * context_ ) const
{
...
void Magick::DrawablePoint::operator()( MagickLib::DrawingWand * context_ ) const
{
...
void Magick::DrawableSkewY::operator()( MagickLib::DrawingWand * context_ ) const
{
...
void Magick::PathArcAbs::operator()( MagickLib::DrawingWand * context_ ) const
{
...
void Magick::PathArcRel::operator()( MagickLib::DrawingWand * context_ ) const
{
  for( PathArcArgsList::const_iterator p = _coordinates.begin();
       p != _coordinates.end(); p++ )
    {
...
void Magick::PathClosePath::operator()( MagickLib::DrawingWand * context_ ) const
{
...
void Magick::PathLinetoAbs::operator()( MagickLib::DrawingWand * context_ ) const
{
  for( CoordinateList::const_iterator p = _coordinates.begin();
       p != _coordinates.end(); p++ )
    {
...
void Magick::PathLinetoRel::operator()( MagickLib::DrawingWand * context_ ) const
{
  for( CoordinateList::const_iterator p = _coordinates.begin();
       p != _coordinates.end(); p++ )
    {
...
void Magick::PathMovetoAbs::operator()( MagickLib::DrawingWand * context_ ) const
{
  for( CoordinateList::const_iterator p = _coordinates.begin();
       p != _coordinates.end(); p++ )
    {
...
void Magick::PathMovetoRel::operator()( MagickLib::DrawingWand * context_ ) const
{
  for( CoordinateList::const_iterator p = _coordinates.begin();
       p != _coordinates.end(); p++ )
    {
