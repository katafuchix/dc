  ...
  if (*name == '#')
    {
      ...
      */
      ...
      color->red=(MagickRealType) (QuantumRange*pixel.red/
        (pow(2.0,1.0*depth)-1.0));
      color->green=(MagickRealType) (QuantumRange*pixel.green/
        (pow(2.0,1.0*depth)-1.0));
      color->blue=(MagickRealType) (QuantumRange*pixel.blue/
        (pow(2.0,1.0*depth)-1.0));
      ...
      if ((n % 3) != 0)
        {
          ...
          color->opacity=(MagickRealType) (QuantumRange-
            QuantumRange*pixel.opacity/(pow(2.0,1.0*depth)-1.0));
        }
      color->index=0.0;
      return(MagickTrue);
    }
